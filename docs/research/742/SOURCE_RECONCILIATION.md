...
- The service publication establishes a 55-degree steering limit. Displayed angles emerge from one continuous translated rack and invariant bars per axle, with the rear linkage mirrored for circle mode. Rack, arm and bar coordinates remain reconstructed. The four-wheel ICR fit, residual crab toe, and conservative 15-percent front-only rack input are measured implementation properties, not factory steering, controller-limit, or crab calibration.
